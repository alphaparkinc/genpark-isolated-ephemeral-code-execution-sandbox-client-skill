# genpark-isolated-ephemeral-code-execution-sandbox-client-skill
...
> **GenPark AI Agent Skill** -- Isolated ephemeral code execution sandbox client & microVM runner (E2B style)
